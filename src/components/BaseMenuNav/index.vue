<template>
  <div class="open-menu-nav" @click="openMenuNav = true" v-show="!openMenuNav">
    菜单导航
  </div>
  <el-drawer
      v-model="openMenuNav"
  ...
  >
    ...
    >
      <el-sub-menu index="1">
        <template #title>
          <div class="nav-bg">
            <div class="nav-collapse" :class="{'collapse-loading': currentCollapse === 1}"></div>
            <span class="nav-text">地图展示</span>
          </div>
        </template>
        <el-menu-item index="Cesium">
          <div class="sub-menu">3D地球展示页面</div>
        </el-menu-item>
        <el-menu-item index="Leaflet">
          <div class="sub-menu">2D地图展示</div>
        </el-menu-item>
        <el-menu-item index="Echarsmap">
          <div class="sub-menu">echars地图展示</div>
        </el-menu-item>
      </el-sub-menu>
      <el-sub-menu index="2">
        <template #title>
          <div class="nav-bg">
            <div class="nav-collapse" :class="{'collapse-loading': currentCollapse === 2}"></div>
            <span class="nav-text">流程展示</span>
          </div>
        </template>
        <el-menu-item index="Jsplumb">
          <div class="sub-menu">流程图显示</div>
        </el-menu-item>
      </el-sub-menu>
      <el-sub-menu index="3">
        <template #title>
          <div class="nav-bg">
            <div class="nav-collapse" :class="{'collapse-loading': currentCollapse === 3}"></div>
            <span class="nav-text">三维展示</span>
          </div>
        </template>
        <el-menu-item index="Threejs"><div class="sub-menu">threejs</div></el-menu-item>
      </el-sub-menu>
      <el-menu-item index="/"><div class="sub-menu">首页</div></el-menu-item>
    </el-menu>
  </el-drawer>
</template>
...
export default {
  name: 'BaseMenuNav',
  setup() {
    const openMenuNav = ref(false)
    const currentCollapse = ref(-1)
    const handleOpen = (key, keyPath) => {
      currentCollapse.value = -1
      nextTick(() => {
        currentCollapse.value = +key
      })
      ...
      .el-sub-menu {
        ...
        .nav-bg {
          ...
          .nav-collapse {
            ...
            &.collapse-loading {
              animation: rotateCollapse .4s linear;
